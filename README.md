...
**Instagram Post Scraper** — Instagram Post Scraper - Collect public post metadata and engagement signals for creator research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/instagram-post-scraper?style=social)
...
>
> **Search intent:** collect public Instagram data for creator research, content analysis, and social listening. Related topics: instagram data, creator research, social media data, python, data extraction.

## What this project is for

`instagram-post-scraper` is an implementation-focused Python project for collecting public Instagram data. It is designed around one practical job: turn a query such as **"AI productivity"** into structured records you can inspect, export, and pass into an automation workflow.
